!(function () {
  ...
  (e.version = '2.1.2'),
    ...
    (e.FieldRef = function (t, r) {
      (this.docRef = t),
        (this.fieldName = r),
        (this._stringValue = r + e.FieldRef.joiner + t);
    }),
    (e.FieldRef.joiner = '/'),
    ...
    (e.tokenizer = function (t) {
      ...
      for (
        var r = t.toString().trim().toLowerCase(),
          i = r.length,
          n = [],
          s = 0,
          o = 0;
        ...
        var a = s - o;
        (r.charAt(s).match(e.tokenizer.separator) || s == i) &&
          (a > 0 &&
            n.push(
              new e.Token(r.slice(o, s), { position: [o, a], index: n.length })
            ),
          (o = s + 1));
      }
      return n;
      ...
      var e = {
        ...
        T = function (r) {
          ...
          if (
            ...
            b.test(r)
              ? (r = r.replace(b, '$1$2'))
              : P.test(r) && (r = r.replace(P, '$1$2')),
            (b = d),
            (P = h),
            b.test(r))
          ) {
            var F = b.exec(r);
            (b = n).test(F[1]) && ((b = c), (r = r.replace(b, '')));
          } else
            P.test(r) &&
              ((i = (F = P.exec(r))[1]),
              (P = a).test(i) &&
          ...
          return (
            ...
            (P = w),
            b.test(r)
              ? ((i = (F = b.exec(r))[1]), (b = s).test(i) && (r = i))
              : P.test(r) &&
                ((i = (F = P.exec(r))[1] + F[2]), (P = s).test(i) && (r = i)),
            (b = k).test(r) &&
              ((i = (F = b.exec(r))[1]),
              (P = o),
              (E = L),
              ((b = s).test(i) || (P.test(i) && !E.test(i))) && (r = i)),
            (b = Q),
            (P = s),
            b.test(r) && P.test(r) && ((b = c), (r = r.replace(b, ''))),
    ...
    (e.TokenSet.fromFuzzyString = function (t, r) {
      for (
        ...
        if (s.str.length > 0) {
          var o;
          (u = s.str.charAt(0)) in s.node.edges
            ? (o = s.node.edges[u])
            : ((o = new e.TokenSet()), (s.node.edges[u] = o)),
            1 == s.str.length
              ? (o.final = !0)
              : n.push({
                  node: o,
        ...
        if (s.editsRemaining > 0 && s.str.length > 1) {
          ...
          u in s.node.edges
            ? (a = s.node.edges[u])
            : ((a = new e.TokenSet()), (s.node.edges[u] = a)),
            s.str.length <= 2
              ? (a.final = !0)
              : n.push({
                  node: a,
        ...
        if (
          (s.editsRemaining > 0 && 1 == s.str.length && (s.node.final = !0),
        ...
        if (s.editsRemaining > 0 && s.str.length > 1) {
          ...
          f in s.node.edges
            ? (h = s.node.edges[f])
            : ((h = new e.TokenSet()), (s.node.edges[f] = h)),
            1 == s.str.length
              ? (h.final = !0)
              : n.push({
                  node: h,
    ...
    (e.TokenSet.fromString = function (t) {
      for (
        var r = new e.TokenSet(), i = r, n = !1, s = 0, o = t.length;
        s < o;
        s++
      ) {
        var a = t[s],
          ...
          for (var d = s[l], h = 0; h < u; h++) {
            ...
            if (c == d || '*' == d) {
              var f = i.node.edges[c],
                ...
                m = void 0;
              c in i.output.edges
                ? ((m = i.output.edges[c]).final = m.final || y)
                : (((m = new e.TokenSet()).final = y), (i.output.edges[c] = m)),
    ...
    (e.Index.prototype.query = function (t) {
      ...
      for (b = 0; b < r.clauses.length; b++) {
        ...
        for (var a = 0; a < o.length; a++) {
          ...
          s.term = u;
          for (
            var l = e.TokenSet.fromClause(s),
              d = this.tokenSet.intersect(l).toArray(),
              h = 0;
            h < d.length;
            h++
          )
            for (
              var c = d[h], f = this.invertedIndex[c], p = f._index, y = 0;
              y < s.fields.length;
              y++
            ) {
              var m = s.fields[y],
                g = f[m],
                x = Object.keys(g);
              m in n || (n[m] = new e.Vector()),
                n[m].upsert(p, 1 * s.boost, function (e, t) {
                  return e + t;
                });
              for (var v = 0; v < x.length; v++) {
                ...
                (w = g[Q]),
                  (k = new e.MatchData(c, m, w)),
                  L in i ? i[L].combine(k) : (i[L] = k);
              }
            }
        }
      }
      for (var T = Object.keys(i), S = {}, b = 0; b < T.length; b++) {
        var P = e.FieldRef.fromString(T[b]),
          E = P.docRef,
          I = this.fieldVectors[P],
          F = n[P.fieldName].similarity(I);
        E in S
          ? ((S[E].score += F), S[E].matchData.combine(i[P]))
          : (S[E] = { ref: E, score: F, matchData: i[P] });
      }
    ...
    (e.Builder.prototype.add = function (t) {
      ...
      for (var i = 0; i < this._fields.length; i++) {
        ...
        (this.fieldTermFrequencies[u] = l),
          (this.fieldLengths[u] = 0),
          (this.fieldLengths[u] += a.length);
        for (var d = 0; d < a.length; d++) {
          ...
          if (
            ...
            for (var f = 0; f < this._fields.length; f++)
              c[this._fields[f]] = Object.create(null);
            this.invertedIndex[h] = c;
          }
          void 0 == this.invertedIndex[h][n][r] &&
            (this.invertedIndex[h][n][r] = Object.create(null));
          for (var p = 0; p < this.metadataWhitelist.length; p++) {
            var y = this.metadataWhitelist[p],
              m = h.metadata[y];
            void 0 == this.invertedIndex[h][n][r][y] &&
              (this.invertedIndex[h][n][r][y] = []),
              this.invertedIndex[h][n][r][y].push(m);
          }
        }
      }
    }),
    ...
    (e.Builder.prototype.createFieldVectors = function () {
      for (
        ...
        for (
          var s = e.FieldRef.fromString(r[n]),
            o = s.fieldName,
          ...
          var f = d[c],
            ...
            m =
              (e.idf(this.invertedIndex[f], this.documentCount) *
                ((this._k1 + 1) * p)) /
              (this._k1 *
